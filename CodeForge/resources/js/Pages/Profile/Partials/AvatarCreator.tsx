...
interface Avatar {
    ...
    accessory: "none" | "cap" | "earphones" | "circleEarring" | "earring" | "futuristicGlasses";
...
export default function AvatarCreator() {
  ...
  const renderAvatar = () => {
    return (
      <div id="avatar-svg" className="relative w-full h-full">
        {/* Base Face */}
        ...
        {/* Outfit */}
        <div className="absolute top-0 left-0 w-full h-full">
          {avatar.outfit === "outfit01" ? <Outfit01 /> : avatar.outfit === "outfit02" ? <Outfit02 /> : null}
        </div>
      </div>
    )
  }
    ...
    <div className="flex flex-col md:flex-row gap-8 w-full max-w-6xl mx-auto p-4">
      ...
      <div className="flex-1 flex flex-col items-center gap-4">
        <div className="p-8 flex items-center justify-center bg-white rounded-lg shadow-md">
          <div className="w-64 h-64 md:w-80 md:h-80">{renderAvatar()}</div>
        </div>
        ...
        <Tabs defaultValue="face">
          ...
          <TabsContent value="face" className="space-y-4">
            <div className="space-y-2">
              ...
              <RadioGroup
                ...
                onValueChange={(value: "fair" | "beard") => updateAvatar("face", value)}
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                ...
                onValueChange={(value: "normal" | "angry") => updateAvatar("eyes", value)}
                className="flex gap-4"
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="normal" id="normal-eyes" />
                  <Label htmlFor="normal-eyes">Normal</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="angry" id="angry-eyes" />
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                ...
                onValueChange={(value: "normalSmile" | "smiley") => updateAvatar("mouth", value)}
                className="flex gap-4"
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="normalSmile" id="normal-smile" />
                  <Label htmlFor="normal-smile">Normal Smile</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="smiley" id="smiley" />
          ...
          <TabsContent value="hair" className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={avatar.hair} onValueChange={(value: "style01" | "style02") => updateAvatar("hair", value)}>
                <SelectTrigger>
                  <SelectValue placeholder="Select hair style" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">None</SelectItem>
                  <SelectItem value="style01">Style 1</SelectItem>
                  <SelectItem value="style02">Style 2</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </TabsContent>
          ...
          <TabsContent value="features" className="space-y-4">
            <div className="space-y-2">
              <Label>Outfit</Label>
              <Select value={avatar.outfit} onValueChange={(value: "outfit01" | "outfit02") => updateAvatar("outfit", value)}>
                <SelectTrigger>
                  <SelectValue placeholder="Select outfit" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">None</SelectItem>
                  <SelectItem value="outfit01">Outfit 1</SelectItem>
                  <SelectItem value="outfit02">Outfit 2</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </TabsContent>
          ...
          <TabsContent value="accessories" className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={avatar.accessory} onValueChange={(value:"none"|"cap"|"earphones"|"circleEarring"|"earring"|"futuristicGlasses") => updateAvatar("accessory", value)}>
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="circleEarring">Circle Earring</SelectItem>
                  <SelectItem value="earring">Earring</SelectItem>
                  <SelectItem value="futuristicGlasses">Futuristic Glasses</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </TabsContent>
