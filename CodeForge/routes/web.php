...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('pages')->group(function () {
        ...
        //sidebar
        Route::post('/{notebookId}', [PageController::class, 'store'])->name('pages.create'); // create a page
        Route::patch('/{notebookId}/pages/{id}', [PageController::class, 'rename'])->name('pages.rename'); // update a page
